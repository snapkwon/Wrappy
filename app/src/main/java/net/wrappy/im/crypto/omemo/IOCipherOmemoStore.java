 ...
 * @author Paul Schaub
 */
public abstract class IOCipherOmemoStore<T_IdKeyPair, T_IdKey, T_PreKey, T_SigPreKey, T_Sess, T_Addr, T_ECPub, T_Bundle, T_Ciph>
        extends OmemoStore<T_IdKeyPair, T_IdKey, T_PreKey, T_SigPreKey, T_Sess, T_Addr, T_ECPub, T_Bundle, T_Ciph> {

    private static final Logger LOGGER = Logger.getLogger(IOCipherOmemoStore.class.getSimpleName());
    private final FileHierarchy hierarchy;

    public IOCipherOmemoStore() {
