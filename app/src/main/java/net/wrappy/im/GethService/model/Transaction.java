...
public class Transaction {
     ...
     */
    public Transaction(GethLight eth) throws Exception {
        if (eth == null) throw new GethLightServiceException(NO_CONTEXT_ERROR);
        this.eth = eth;
    ...
    public Transaction to(Address account) {
        if (to == null) throw new GethLightServiceException(NO_RECIPIENT_ERROR);
        this.to = account;
        return this;
    }
    ...
    public Transaction from(Account account, String passphrase) {
        if (account == null) throw new GethLightServiceException(NO_SENDER_ERROR);
        this.from = account;
    ...
    private boolean checkValidity() throws Exception {
        if (to == null) throw new GethLightServiceException(NO_RECIPIENT_ERROR);
        if (from == null) throw new GethLightServiceException(NO_SENDER_ERROR);
        return true;
    }
    ...
    private org.ethereum.geth.Transaction sign() throws Exception {
        ...
        if (from == null) throw new GethLightServiceException(NO_SENDER_ERROR);
        if (this.eth.getKeyManager() == null) throw new GethLightServiceException(NO_KEYMANAGER_ERROR);
