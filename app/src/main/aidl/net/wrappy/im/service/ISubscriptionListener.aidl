...
/**
     ...
     *  </ul>
     *
     * @see im.SubscriptionRequestListener#onSubScriptionRequest(Contact from)
     */
     ...
     *
     * @see im.SubscriptionRequestListener#onSubscriptionApproved(String contact)
     */
     ...
     *
     * @see im.ContactListListener#onSubscriptionDeclined(String contact)
     */
