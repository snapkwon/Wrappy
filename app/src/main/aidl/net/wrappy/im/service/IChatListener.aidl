...
interface IChatListener {
     ...
     */
    boolean onIncomingMessage(IChatSession ses, in net.wrappy.im.model.Message msg);
     ...
     */
    void onSendMessageError(IChatSession ses, in net.wrappy.im.model.Message msg, in ImErrorInfo error);
